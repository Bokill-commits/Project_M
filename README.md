...
이에 따라,
- 패킷/페이로드 분석 없이
- **행위 기반 Feature만으로 의심 트래픽 탐지 가능성 검증**
...
- Mock 데이터를 생성하여 테스트 환경 구성
- LLM 기반 도구를 활용하여 개발 생산성 향상
...
행위 기반 Feature만으로도  
의심 트래픽 탐지 가능성을 확인했으며,  

실시간 사용자 경고 시스템과 결합하여  
**경량 보안 탐지 시스템으로 활용 가능함을 검증했습니다.**
